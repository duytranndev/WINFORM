namespace WFPTB2_OutSideClass
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "GIẢI PHƯƠNG TRÌNH BẬC 2 NEW";
			// 
			// label2
			// 
			...
			this.button1.Click += new System.EventHandler(this.btn_Click_Run);
			// 
			// button2
			// 
			...
			this.button2.Click += new System.EventHandler(this.btn_Click_Reset);
			// 
			// button3
			// 
